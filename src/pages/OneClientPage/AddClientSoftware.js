...
function AddClientSoftware({ clientId, show, handleClose, setRefresh }) {
    ...
    const handleAddExistingSoftware = async () => {
        if (selectedSoftware) {
            ...
            console.log(selectedSoftware.value)
        ...
        <Modal show={show} onHide={handleClose}>
            ...
            <Modal.Body>
                <Container>
                    ...
                    <Button variant="link" onClick={() => setShowAddNew(!showAddNew)}>
                        {showAddNew ? 'Select Existing Software' : 'Add New Software'}
                    </Button>
                    {showAddNew ? (
                        ...
                        <>
                            ...
                            />
                            <Button variant="success" className="mt-3" onClick={handleAddExistingSoftware}>
